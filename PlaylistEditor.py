...
def fillPlaylist():
    ...
    index -= 1
    print ">>-------------------------------------<<"
    selection = input("Please type the number of the playlist you wish to import into the bot's backup playlist, then press ENTER. \n")
    while (selection < 1) or (selection > index):
        selection = input("The number you have entered is invalid. Please enter a number between 1 and " + str(index) + ". \n")
    selection -= 1
...
print ">>-------------------------------------<<"
inp = input("Type the number of the option you would like here then press ENTER: \n")
if inp == 1:
    fillPlaylist()
if inp == 2:
    shuffleplaylist()
